  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(`Error updating TODO: ${errorData.message}`);
      }
    } catch (error) {
      console.error("Error:", error);
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none ms:flex-row focus:ring-2 focus:ring-blue-500"
            >
