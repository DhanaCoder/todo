...
const TodoCard = ({ todo }) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-md border border-gray-200 my-4 p-4">
      <h3 className="text-xl font-semibold text-gray-900 mb-2">{truncateText(todo.title, TRUNCATE_LENGTH)}</h3>
